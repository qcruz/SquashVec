...
const STARTER_DECK = [
  ...
  'public_works', 'public_works', 'public_works', 'civic_charter', 'civic_charter',
...
const LEAN_DECK = [
  ...
  'alliance',
  'free_trade_agreement', 'free_trade_agreement',
  'efficient_administration', 'efficient_administration', 'tax_collection', 'tax_collection', 'tax_collection', 'tax_collection','tax_increase', 'tax_decrease',
  'cultural_festival', 'cultural_festival', 'cultural_festival', 'military_campaign',
  'scientific_breakthrough',
  'abundant_harvest', 'abundant_harvest', 'abundant_harvest', 'abundant_harvest',
  'inspiring_speech',
  'activists', 'activists', 'unions', 'unions', 'loyalists', 'loyalists', 'loyalists',
  'public_works', 'public_works', 'civic_charter', 'civic_charter', 'civic_charter',
