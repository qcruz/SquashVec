...
const CARDS = [
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'Remove 1 Economy resource from your stack and shuffle it into the draw deck. Stack this card on Governance as a +2 resource.',
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'Remove 1 Culture resource from your stack and shuffle it into the draw deck. Stack this card on Governance as a +2 resource.',
        effect: 'pay_own_stack_then_stack_on_any',
        ownCategory: 'culture',
        choices: ['governance'],
      },
...

  {
    ...
    options: [
      ...
      {
        label: 'Option 2 — Focus Elsewhere',
        description: 'Remove 1 Military resource from your stack and shuffle it into the draw deck. Stack this card on Economy as a +2 resource.',
        effect: 'pay_own_stack_then_stack_on_any',
...

  {
    ...
    options: [
      ...
      {
        label: 'Option 2 — Focus Elsewhere',
        description: 'Remove 1 Governance resource from your stack and shuffle it into the draw deck. Stack this card on Economy as a +2 resource.',
        effect: 'pay_own_stack_then_stack_on_any',
        ownCategory: 'governance',
        choices: ['economy'],
      },
...

  {
    ...
    options: [
      ...
      {
        label: 'Option 2 — Focus Elsewhere',
        description: 'Remove 1 Technology resource from your stack and shuffle it into the draw deck. Stack this card on Economy as a +2 resource.',
        effect: 'pay_own_stack_then_stack_on_any',
        ownCategory: 'technology',
        choices: ['economy'],
      },
...

  {
    ...
    options: [
      ...
      {
        label: 'Option 2 — Focus Elsewhere',
        description: 'Remove 1 Environment resource from your stack and shuffle it into the draw deck. Stack this card on Culture as a +2 resource.',
        effect: 'pay_own_stack_then_stack_on_any',
        ownCategory: 'environment',
        choices: ['culture'],
      },
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'Take the oldest resource from your Governance stack and shuffle it into the deck. Stack +2 on Economy.',
        effect: 'pay_own_stack_then_stack_on_any', ownCategory: 'governance', choices: ['economy'],
      },
    ],
    discardTo: [{ target: 'shuffle_to_deck', label: 'Shuffle into deck' }],
  },
